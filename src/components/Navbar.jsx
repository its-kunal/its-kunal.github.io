  ...
  return (
    <>
      <div className="navbarcon flex justify-between items-center px-20 py-6 bg-transparent z-40 text-white lg:px-6 fixed w-full">
        <h1 className="text-4xl  font-bold ">Kunal.dev</h1>
        ...
        >
          ...
          <div className="btn">
            <button
              ...
              onClick={(e) => {
                window.open("https://www.linkedin.com/in/kunalagrawal24/");
              }}
            >
              Let's Connect
            </button>
