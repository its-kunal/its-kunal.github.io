    ...
    <div className="grid grid-cols-3 h-80">
      ...
      <div className="col-span-2 self-center flex flex-col gap-y-4">
        ...
        <p className="text-gray-500">
          Hi, I'm Kunal Agrawal a Full Stack Web Developer from India. Develops
          high quality Web Applications using MERN stack.
        </p>
        <div className="flex gap-x-2">
          <button className="bg-red-600 px-2 py-1 text-white rounded">
            Learn More
          </button>
          <button className="border border-gray-500 px-2 py-1 rounded text-gray-500">View CV</button>
        </div>
      </div>
      {/* Image */}
